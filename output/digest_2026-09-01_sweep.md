...
- [ ] Edoardo Fazzari  (person)  <!--id:person::https://openalex.org/A5093194507-->
   - [fallback] overlaps 1 of your topics (animal social learning); e.g. "Animal behavior analysis methods using deep learning: A survey"
   - Istituto di Scienza e Tecnologie dell'Informazione "Alessandro Faedo"
   - https://openalex.org/A5093194507
...
- [ ] Cesare Stefanini  (person)  <!--id:person::https://openalex.org/A5067436187-->
   - [fallback] overlaps 1 of your topics (animal social learning); e.g. "Animal behavior analysis methods using deep learning: A survey"
   - Piaggio (Italy)
   - https://openalex.org/A5067436187
